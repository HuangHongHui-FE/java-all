...
class Test {
    public static void main(String[] args) {
        ...
        System.out.println("（从左->右）构成：有" + count1 + "种");
        System.out.println("（从上->下）构成：有" + count2 + "种");
        System.out.println("（从左上->右下）构成：有" + count3 + "种");
        System.out.println("（从左下->右上）构成：有" + count4 + "种");
    }
}
